...
const Table = ({url, point1, point2, setPoint1, setPoint2}) => {
  ...
  const clickButtonDownload = ()=>{
    ...
    (point1<point2) ? getSamples(url,  point1, point2).then(()=>{setDownloadFile(false)}) : alert('Start Point must be less than End Point')
      ...
      <div className="table-responsive">
        <div className="table-wrapper d-flex justify-content-center">
          ...
          <table className="table table-striped w-50" >
            ...
            <tbody  >
              <tr>
                <td > <div class="card-body text-center mt-2 font-weight-bold" >{nameFile}</div></td>
                <td >
